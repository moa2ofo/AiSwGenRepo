#ifndef ERRORDATADETECTION_PRIV_H
...
#define EDD_CRC8_POLY (0x07u) /**< CRC polynomial: x^8 + x^2 + x + 1 */
#define EDD_CRC8_INIT (0x00u) /**< CRC initial value */
...
#endif /* ERRORDATADETECTION_PRIV_H */
